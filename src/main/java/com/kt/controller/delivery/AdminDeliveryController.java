...
public class AdminDeliveryController {
	...
	@PostMapping("/{deliveryId}/tracking-number")
	public ApiResponseEntity<DeliveryResponse.Detail> registerTrackingNumber(
		@PathVariable Long deliveryId,
		@Valid @RequestBody DeliveryRequest.RegisterTracking request
	) {
		var response = deliveryService.registerTrackingNumber(deliveryId, request);
		return ApiResponseEntity.success(response);
	}
}
